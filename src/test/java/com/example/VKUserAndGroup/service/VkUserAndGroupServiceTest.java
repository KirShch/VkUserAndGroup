...
class VkUserAndGroupServiceTest {
    ...
    void memberNotEmptyError() {
        ...
        assertThrows(VkApiException.class, () -> vkUserAndGroupService.member(vkResponse));
    }
    ...
    void getVkUserNotEmptyError() {
        ...
        vkResponse.setError(new VkApiError());
        assertThrows(VkApiException.class, () -> vkUserAndGroupService.getVkUser(vkResponse));
    }

    @Test
    void getVkUserNullErrorAndListOfVkUsers() {
        VkApiUserGetResponse<VkUser> vkResponse = new VkApiUserGetResponse<>();
        assertThrows(VkApiUserNotFoundException.class, () -> vkUserAndGroupService.getVkUser(vkResponse));
    }
